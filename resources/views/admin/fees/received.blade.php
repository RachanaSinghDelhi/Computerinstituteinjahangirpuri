        ...
        <tbody>
            @foreach ($fees as $fee)
                <tr>
                    ...
                    <td> <a href="{{ route('admin.add_fees', $fee->student_id) }}" class="btn btn-primary btn-sm">Pay Now</a>
                    <a href="{{ route('admin.fees.show', $fee->student_id) }}" class="btn btn-info btn-sm">View Details</a> </td>    
                </tr>
            @endforeach
        </tbody>
    </table>
