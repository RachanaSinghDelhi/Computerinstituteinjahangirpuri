            ...
            <div class="container container-fluid">
                ...
                <div class="collapse navbar-collapse" id="topbar">
                   ...
                   <ul class="navbar-nav me-auto mb-2 mb-lg-0  menu_list">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="#"><i class="fa fa-paper-plane" style="color:#fff;"></i>  A1- 9/10, Jahangirpuri Rd, A block Rd, Near Da Pizza Palace,Bhalaswa Jahangirpuri, Delhi, 110033</a>
                        </li>
                        <li class="nav-item">
