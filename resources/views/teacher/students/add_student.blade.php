...
<div class="container mt-5">
    ...
    <!-- Add Course Button -->
    <div class="mb-3">
        <a href="{{ route('teacher.students.index') }}" class="btn btn-success btn-sm">
    ...
    <form action="{{ route('teacher.students.store') }}" method="POST" enctype="multipart/form-data" id="studentForm">
        @csrf
