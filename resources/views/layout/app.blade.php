...
<!-- Google tag (gtag.js) -->
<script async src="https://www.googletagmanager.com/gtag/js?id=G-6H652W62BK">
</script>
<script>
  ...
  gtag('config', 'G-6H652W62BK');
    ...
    })(window,document,'script','dataLayer','GTM-5F4SJVC9');</script>
...
<body>
    ...
    <noscript><iframe src="https://www.googletagmanager.com/ns.html?id=GTM-5F4SJVC9"
    height="0" width="0" style="display:none;visibility:hidden"></iframe></noscript>
    <!-- End Google Tag Manager (noscript) -->

    <div class="main-top" style="z-index: 1000;">
    ...
    @php
    // Define the routes where the banner should NOT be displayed.
    $noBannerRoutes = ['login.form', 'admin.login'];
    $currentRoute = request()->route() ? request()->route()->getName() : '';
@endphp

{{-- Conditional Banner Section --}}
@if (in_array($currentRoute, $noBannerRoutes))
    {{-- Do not display any banner for login or admin login pages --}}
...
@else
    {{-- Dynamic Banner for Other Pages --}}
    <div class="banner" style="background-image: url('{{ $bannerImage ?? asset('assets/images/Sliders_image/medal1_nice_computer_institute_jahangirpuri.jpg') }}'); height: 400px; background-size: cover; background-position: center;">
...
<div class="container">
    @php
        // List of route names where the sidebar should not be displayed.
        $noSidebarRoutes = ['login.form', 'admin.login', 'index'];
        $currentRoute = request()->route() ? request()->route()->getName() : '';
    @endphp

    @if (in_array($currentRoute, $noSidebarRoutes))
        @if ($currentRoute == 'login.form')
            <!-- Login page styling with centered content -->
        ...
        @else
            <!-- For index and admin.login routes, just output the content without sidebar -->
            @yield('content')
        @endif
    @else
        <!-- For all other routes, include the sidebar -->
        <div class="row">
            <div class="col-md-8">
                @yield('content')
            </div>
