<section class="about">
<header2>
<div class="header_image carousel slide crousel-image-height">
        
                        <!-- Assuming this is in your about_body.blade.php -->

                        <img src="{{ asset('assets/images/Sliders_image/medal1_nice_computer_institute_jahangirpuri.jpg') }}" alt="Medal Image">

            
             <div class="carousel-caption">
                        <h5 class="animate__animated animate__bounceInRight animate__delay-1s">About Us</h5>
                      
                    </div>

        </div>
public/assets/images/Sliders_image/medal1_nice_computer_institute_jahangirpuri.jpg
