<div class="d-flex" id="wrapper">
    ...
    <div class="bg-dark text-white" id="sidebar" style="width: 250px; height: 100%; transition: all 0.3s;">
        <nav class="nav flex-column p-3">
            ...
            <!-- ToggleDown Menu for Courses -->
            <a href="#courseMenu" class="nav-link text-white" data-bs-toggle="collapse" aria-expanded="false" aria-controls="courseMenu">
                <i class="fa fa-book"></i> <span>Courses</span>
                <i class="fa fa-chevron-down ms-2 arrow"></i>
            </a>
            <div class="collapse" id="courseMenu">
                <a href="{{ route('course.create') }}" class="nav-link text-white ms-3">
                    <i class="fa fa-plus"></i> <span>Add Course</span>
                </a>
                <a href="{{ route('course.index') }}" class="nav-link text-white ms-3">
                    <i class="fa fa-list"></i> <span>Course List</span>
                </a>
            </div>
            ...
            <div class="collapse" id="studentMenu">
                <a href="{{ route('students.create') }}" class="nav-link text-white ms-3">
                    <i class="fa fa-user-plus"></i> <span>Add Student</span>
                </a>
                <a href="{{ route('student.index') }}" class="nav-link text-white ms-3">
                    <i class="fa fa-users"></i> <span>Ajax Student</span>
                </a>
                <a href="{{ route('students.index') }}" class="nav-link text-white ms-3">
