...
class PostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('admin.posts.new_posts')->with('success', 'Post created successfully.');
    }
    ...
    public function update(Request $request, $id){
        ...
        return redirect()->route('admin.posts.new_posts')->with('success', 'Post updated successfully.');
    }
    ...
    public function index()
    {
        ...
        return view('admin.posts.new_post', compact('posts'));
    }
